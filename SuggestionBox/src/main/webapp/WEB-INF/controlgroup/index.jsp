...
<html>
    ...
    <head>
        ...
        <title>Controlgroup Dashboard</title>
    ...
    <body>
        ...
        <div>
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <p>This is your home page. Here you can create and edit procedures for suggestions.</p>
                        <hr>
                        ...
                        <div class="row suggestions">
                            ...
                            <form action="ControlGroupController" method="GET">
                                <input type="text" name="title" placeholder="Search from title"/>
                                <button type="submit" class="btn btn-success">Search</button>
                            </form>
                            
                            <p id="clearSearch"><a href="ControlGroupController"><button type="submit" class="btn btn-info">Clear Search</button></a></p>
                        </div>
                        <hr>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <a href="ProcedureController?suggestionId=${currentSuggestion.id}"><button type="button" class="btn btn-info float-right management-control">Add/Edit Procedure</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
